...
import { Save, Sparkles, FileBarChart } from 'lucide-react';
import { 
  AsyncLocationSelect, 
  AsyncAssetSelect, 
  AsyncUserSelect,
            ...
            <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 md:px-8 lg:px-10">
              <div className="space-y-8">
                <div className="flex items-center justify-between">
                  <div className="flex flex-col">
                    <div className="mb-2 flex items-center gap-3">
                      ...
                      <h1 className="text-2xl font-bold text-gray-900">New Permit to Work</h1>
                    </div>
                    <StepIndicator />
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-6 space-y-8">
                  <div className="grid gap-6">
                    <div className="space-y-2">
                      ...
                      <Input placeholder="e.g. Hot Work for Pipe Repair" />
                    </div>

                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                      <div className="space-y-2">
                        <Label>Permit Type <span className="text-red-500">*</span></Label>
                        <Input placeholder="e.g. Hot Work, Confined Space..." />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                      ...
                      <div className="space-y-2">
                        <Label>Asset</Label>
                        <AsyncAssetSelect placeholder="Select asset..." />
                      </div>
                      <div className="space-y-2">
                ...
                <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-6">
                  <ApproversSelector title="Approval Workflow" description="Select people to approve this permit." />
                </div>
